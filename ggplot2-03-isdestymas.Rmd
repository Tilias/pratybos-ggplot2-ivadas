...
```{r}
ggplot(data = mpg) + 
  geom_point(mapping = aes(x=cty, y=displ, color=cty))
```
```{r}
ggplot(data = mpg) + 
  geom_point(mapping = aes(x=cty, y=displ, size=cty))
...
```{r}
ggplot(data = mpg) + 
  geom_point(mapping = aes(x=model, y=displ, color=model))
...
```{r}
ggplot(data = mpg) + 
  geom_point(mapping = aes(x=cty, y=displ, stroke=cty))
?stroke
```
...
```{r}
ggplot(data = mpg) + 
  geom_point(mapping = aes(x=cty, y=displ, color=cty, size=displ))
```
...
```{r}
ggplot(data = mpg) + 
  geom_point(mapping = aes(x=cty, y=displ, color=cty, size=cty))
```
...
```{r}
ggplot(data = mpg) + 
  geom_point(mapping = aes(x=displ, y=cty, color=as.factor(displ)))
